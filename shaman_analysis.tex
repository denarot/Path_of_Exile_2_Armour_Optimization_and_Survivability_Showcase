...
\begin{itemize}
    ...
    \item \textbf{Binding Constraint: Conversion Releases the Armour Budget.} The character-sheet analysis in Section~3 establishes the paper's central diagnostic. Against $H = 10{,}000$, Smith of Kitava with 100{,}000 armour takes 5{,}000 damage; Shaman with 25{,}000 armour and 75\% physical-to-elemental conversion takes 1{,}923. Matching Shaman's 80.8\% total mitigation through armour alone requires approximately 421{,}000 armour rating --- beyond any achievable gear. The gap is structural: conversion suppresses the effective hit size before it enters the formula, making the same armour 4$\times$ more efficient per point. The 8--15 passive points Smith commits to armour scaling are freed on Shaman for damage, sustain, or additional defensive layers. This is not a performance margin --- it is a structural release of the build's binding constraint.
...
\midrule
5{,}686
  & \cellcolor{tierD}28.5\%
  & \cellcolor{tierD}63.8\%
  & \cellcolor{tierD}63.8\%
  & \cellcolor{tierB}85.8\%
  & Crossover \\
\midrule
8{,}000
...
\midrule
\rowcolor{rowhi} 10{,}000 & 8{,}000 & \textbf{5{,}000} & \textbf{3{,}625} & \textbf{1{,}923} & \textbf{5{,}001} & \textbf{3{,}625} \\
\bottomrule
\end{tabular}
}
\smallskip
...
\rowcolor{rowalt} \textbf{Shaman (0 arm, 75\% conv.)} & \textbf{3{,}625} & \textbf{3{,}625} & \textbf{Yes} & \textbf{+0} \\
...
Mind over Matter (MOM) redirects a portion of incoming damage to mana before it reaches life, creating an effective HP buffer from the mana pool. Its value scales with how low the final damage number is.

\textbf{0-armour Shaman} at 3{,}625 damage with 40\% MOM redirect:
\[
\text{Damage to life: } 3{,}625 \times 0.60 = 2{,}175 \qquad \text{Damage to mana: } 3{,}625 \times 0.40 = 1{,}450
\]
A Shaman with 2{,}500 life and 1{,}500 mana survives: life absorbs 2{,}175 (survives at 325 HP), mana absorbs 1{,}450 (depleted). MOM converts the 3{,}625 ceiling into an achievable 2{,}500 life requirement.

\textbf{Full-stack Shaman} (25k armour, 1{,}923 taken) with 40\% MOM:
\[
\text{Damage to life: } 1{,}923 \times 0.60 = 1{,}154 \qquad \text{Damage to mana: } 1{,}923 \times 0.40 = 769
\]
A Shaman with 1{,}500 life and 800 mana survives: life absorbs 1{,}154 (survives at 346 HP), mana absorbs 769 (depleted). The required mana pool is only 769 --- a modest number achievable without dedicated investment.

\textbf{Smith} at 5{,}000 damage with 40\% MOM:
\[
\text{Damage to life: } 5{,}000 \times 0.60 = 3{,}000 \qquad \text{Damage to mana: } 5{,}000 \times 0.40 = 2{,}000
\]
Smith requires both 3{,}001 life \textit{and} 2{,}001 mana simultaneously --- consuming gear affixes and passive points in two separate resources while sustaining the heaviest armour investment possible. MOM compounds Shaman's already-low damage intake into a minimal combined resource requirement; on Smith it treats a structural survivability deficit rather than multiplying an existing advantage.
...
\smallskip
\begin{minipage}{\linewidth}
\small\textit{Invoker expected damage: 25\% of hits land at 7{,}270 each (27.3\% DR at 50k evasion); expected per hit = 1{,}818. Warbringer and Tactician figures from their respective positioning sections. Shaman's S-Tier placement rests on determinism: its worst case equals its expected case because conversion is unconditional. Each Gambler's expected mitigation is competitive with or exceeds Shaman's, but their worst-case damage demands 1.8--3.8$\times$ the HP investment Shaman requires to absorb a single endgame hit. The skill floor is higher on each Gambler --- Meditate for Invoker, manual block for Warbringer, totem management for Tactician --- and variance rises further when those mechanics are unavailable, mistimed, or already spent.}
\end{minipage}
\end{table}
